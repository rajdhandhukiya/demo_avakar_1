...
function LetestNewsCom() {
  const { Meta } = Card;
  const [lat, setLet] = useState(21.17);
    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          message.success("mail was sent successfully", [0.8]);
          setYourName("");
          setEmail("");
          setPhoneNumber("");
          setSelectedValue("");
        ...
        (error) => {
          ...
          message.error("mail was not sent", [0.8]);
        }
      );
  };
      ...
      <div className="latestNews_main">
          ...
          <Row gutter={16}>
            <Col span={8}>
              <Card
                ...
                cover={
                  <img src={Blog1} alt="Blog1" style={{ padding: "10px " }} />
                }
              >
                <Meta
                  title={<p className="Comments">by admin - 3 Comments</p>}
                  description={
                    <p className="paragraph_Head">
                      How does a ductless heat<br></br> pump work?{" "}
                    </p>
                  }
                />
                <div className="buttonic">
                  <p className="passages">
                    There are many variations passages of <br></br>lorem ipsum
            ...
            <Col span={8}>
              <Card
                ...
                className="latest_title"
                cover={
                  <img src={Blog2} alt="Blog2" style={{ padding: "10px " }} />
                }
              >
                <Meta
                  title={<p className="Comments">by admin - 3 Comments</p>}
            ...
            <Col span={8}>
              <Card
                ...
                className="latest_title"
                cover={
                  <img src={Blog3} alt="Blog3" style={{ padding: "10px " }} />
                }
              >
                <Meta
                  title={<p className="Comments">by admin - 3 Comments</p>}
        ...
        <div id="section4">
          <div className="Googlemaping">
            <Row>
              <Col span={12}>
                <div className="google_map" id="section6">
                  <GoogleMapReact
                    options={{
                      mapTypeControl: true,
              ...
              <Col span={12} className="col_padding">
                ...
                <div>
                  <p className="para_header">
                    To request a service call, please fill out <br></br>the form
                    below
                  </p>
                </div>
