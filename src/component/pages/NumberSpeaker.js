        ...
        <div className='Number_main'>
                ...
                <Row justify="center">
                    <Col span={5}>
                        <div className='num_main'>
                            <span className='num_span_count_3'>
                    ...
                    <Col span={5}>
                        <div className='num_main'>
                            <span className='num_span_count_2'>
                ...
                <Row align="bottom">
                    <Col span={4}>
                        ...
                        <div className="overlay" >
                            <div className="text">Maintenance and <br></br>Repair</div>
                            <div ><Button className='buttoner'> {">"}</Button></div>
                            </div>
                        </div>
            ...
            <div className='Founder_details'>
                ...
                <Carousel autoplay align="center">
                    ...
                    <div>
                        <h3 style={contentStyle}> This is due to their excellent service, competitive<br></br>
                            pricing and customer support . It's throughly refresing <br></br>
                            to get such a personal touch.</h3>
                    </div>
                    <div>
                        <h3 style={contentStyle}> This is due to their excellent service, competitive<br></br>
                            pricing and customer support . It's throughly refresing <br></br>
